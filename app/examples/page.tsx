      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 flex flex-col lg:flex-row min-h-0">
          ...
          <div className="flex-1 min-h-0 lg:w-1/2 p-2 lg:p-3 overflow-hidden">
            <CodeViewer code={active.source} fileName={`${active.slug}.rs`} />
          </div>
                ...
                <div className="flex-1 flex items-center justify-center p-6 overflow-auto">
                  <div className="max-w-sm text-center space-y-3">
                    ...
                    <p className="text-xs text-white/20 leading-relaxed">
                      ...
                      The <code className="text-[#0ea5e9]">errno</code> and <code className="text-[#0ea5e9]">polling</code>
                      crates block compilation on the &quot;unknown&quot; OS target.
                    </p>
                    {meta?.error && (
                      <details className="text-left">
                        <summary className="text-[10px] text-white/25 cursor-pointer hover:text-white/50">
                          build error
                        </summary>
                        <pre className="text-[10px] text-[#ef4444]/70 font-mono mt-2 p-3 rounded bg-white/[0.03] whitespace-pre-wrap max-h-32 overflow-y-auto">
                          {meta.error}
                        </pre>
                      </details>
                    )}
