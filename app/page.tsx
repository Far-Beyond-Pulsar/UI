      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-5 flex flex-col items-center text-center">
          ...
          >
            ...
            <span className="text-xs text-white/60 font-medium tracking-wide">Cross-platform · GPU-accelerated</span>
          </motion.div>
          ...
          >
            GPU UI for <span className="text-[#38bdf8]">every platform.</span>
          </motion.h1>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map((feat, i) => (
              <motion.div
                ...
                className="group rounded-xl border border-white/[0.07] bg-white/[0.02] p-5 hover:bg-white/[0.05] hover:border-white/[0.12] transition-all"
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center">
            <div className="inline-flex flex-wrap items-center justify-center gap-2 text-xs text-white/40">
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Buttons</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Menus</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Tabs</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Dropdowns</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Accordions</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Modals</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Popovers</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Sliders</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Switches</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Progress Bars</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Virtual Lists</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Code Editor</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Charts</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Drag & Drop</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Resizable Panels</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Tree Views</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Tooltips</span>
              <span className="px-3 py-1 rounded-full border border-white/[0.07] bg-white/[0.03]">Breadcrumbs</span>
            </div>
          </div>
        </div>
      </section>
